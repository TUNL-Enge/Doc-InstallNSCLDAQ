...
lappend auto_path /usr/opt/spectcl/current/TclLibs
load /usr/opt/spectcl/current/lib/libCalibrations.so
#load /usr/opt/spectcl/current/lib/libApexBarEnergy.so
#load /usr/opt/spectcl/current/lib/libApexBarPosition.so

#------------------------------------------------------------------------
#Creates a sprectrum for the position and energy of the source using the two ApexBar plugins
#apexbarposition Position_01 101 Front Back 151.98 1 980
##spectrum name type parameter {{low high binsize}}
#spectrum Pos_01 1 Position_01 {{400 1600 1200}}
#apexbarenergy Energy_01 102 Front Back .452 .913
#spectrum Eng_01 1 Energy_01 {{0 14999 15000}}
#
#
#
sbind -all
